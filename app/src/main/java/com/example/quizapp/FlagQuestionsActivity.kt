...
class FlagQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Log.i("Questions Size", "${mQuestionsList.size}") //Test if constant works
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            intent.putExtra(FlagConstants.CORRECT_ANSWER, mCorrectAnswers)
